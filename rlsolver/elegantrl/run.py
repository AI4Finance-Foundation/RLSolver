...
def init_buffer(args, gpu_id: int) -> [ReplayBuffer or ReplayBufferList]:
...
def train_and_evaluate(args):
    ...
    if args.if_off_policy:
        trajectory, step = agent.explore_env(env, args.num_seed_steps * args.num_steps_per_episode - args.horizon_len)
