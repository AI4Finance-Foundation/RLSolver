...
With respect to datasest (.txt), the first row includes the number of nodes and edges, and the other rows indicate the two nodes together with the weight of the edge. There are two datasets: __[Gset](https://web.stanford.edu/~yyye/yyye/Gset/)__ and __Syn__ (e.g., syn_n_m.txt is with n nodes and m edges), both of which are in the "data" folder. If users need more synthetic data, please refer to [Google Drive](https://drive.google.com/drive/folders/1gkpndZPj09ew-s9IvrWEZvvCFDWzd7vL) or [Baidu Wangpan](https://pan.baidu.com/s/1QUAAd5rs93fpc2Ixgtm8lw) (CODE 2fw9 for Chinese users). 
...
|-------|------|----| ---- |------|----| ---- |---- |--|---- |---- |--|---- |---- |--|
|syn_10   | 20.80 $\pm$ 2.71 (0.01s) | 0| $\pm$ |  | $\pm$ | | 20.80 $\pm$ 2.71 (0.32s)  | 0| $\pm$  |  | $\pm$ | |$\pm$ |  |
|syn_50   | 138.75 $\pm$ 4.28 (0.14s)  | 0| $\pm$ |  | $\pm$ | | 138.75 $\pm$ 4.28 (6.60s)  | 0| $\pm$  || $\pm$ || $\pm$ ||  $\pm$   |  |
|syn_100  |  342.20 $\pm$ 4.33 (131.07s)|0 | $\pm$ |  | $\pm$ | | 342.20 $\pm$ 4.33 (805.31s) |0 | $\pm$  || $\pm$ || $\pm$ ||  $\pm$   |  |
|syn_300   |  1407.05 $\pm$ 8.55 | | $\pm$ |  | $\pm$ | |   1345.45 $\pm$ 18.49  | | $\pm$  || $\pm$ || $\pm$ ||  $\pm$   |  |
|syn_500   | 2480.95 $\pm$ 15.22| | $\pm$ |  | $\pm$ | |   2325.70 $\pm$ 15.54   | | $\pm$  || $\pm$ || $\pm$ ||  $\pm$   |  |
|syn_700   |  2857.65 $\pm$ 11.96| | $\pm$ |  | $\pm$ | |   $\pm$    | | $\pm$  || $\pm$ || $\pm$ ||  $\pm$   |  |
|syn_900   |  3629.45 $\pm$ 12.06| | $\pm$ |  | $\pm$ | |   $\pm$    | | $\pm$  || $\pm$ || $\pm$ ||  $\pm$   |  |
|syn_1000  |   | | $\pm$ |  | $\pm$ | |   $\pm$    | | $\pm$  || $\pm$ || $\pm$ ||  $\pm$   |  |
|syn_3000  |   | | $\pm$ |  | $\pm$ | |   $\pm$    | | $\pm$  || $\pm$ || $\pm$ ||  $\pm$   |  |
|syn_5000  |   | | $\pm$ |  | $\pm$ | |   $\pm$    | | $\pm$  || $\pm$ || $\pm$ ||  $\pm$   |  |
|syn_7000  |   | | $\pm$ |  | $\pm$ | |   $\pm$    | | $\pm$  || $\pm$ || $\pm$ ||  $\pm$   |  |
|syn_9000  |   | | $\pm$ |  | $\pm$ | |   $\pm$    | | $\pm$  || $\pm$ || $\pm$ ||  $\pm$   |  |
