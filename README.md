...
For combinatorial optimizations (discrete variables) and nonconvex optimizations (continuous variables), we aim to find high-quality optimum, or even global optimum.
